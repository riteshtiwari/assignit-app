...
public class IndexScroller {
	...
	/**
	 * MEthod called on list size changed 
	 * 
	 * @param w
	 * @param h
	 * @param oldw
	...
	/**
	 * method to find list item match or not
	 * @param x
	 * @param y
	 * @return
	 */
	...
	/**
	 * Method to handle Fade functions
	 * Fade 
	 * @param delay
	 */
